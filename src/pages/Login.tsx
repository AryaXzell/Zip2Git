        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 text-left">
          ...
          <div className="bg-slate-50 border border-slate-100 dark:bg-slate-950 dark:border-slate-800 p-3 rounded-xl flex items-start gap-2.5">
            ...
            <div className="text-[11px] text-slate-500 dark:text-slate-400 leading-normal">
              <strong>Disimpan Sementara di Sesi Browser:</strong> Token Anda disimpan murni di memori jangka pendek peramban (sessionStorage) dan otomatis musnah dari memori komputer Anda ketika tab ditutup atau saat Anda keluar (logout). Kami tidak memiliki pelacakan database atau server perantara; seluruh operasi berjalan langsung di peramban Anda.
            </div>
          </div>
